...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { background: @admin_user.background, status: @admin_user.status, sticker: @admin_user.sticker }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { background: @admin_user.background, status: @admin_user.status, sticker: @admin_user.sticker }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
